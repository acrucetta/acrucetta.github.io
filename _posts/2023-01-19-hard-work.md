...
Last year, I changed my mind about work. I believed in strict work-life balance, working enough to meet our needs and enjoy the rest of our time. I've now realized that by seeing work as something to protect or balance against I was stunting the potential of a type of work you could enjoy and wouldn't mind spending hours on.

The concept of work-life balance alienates work as something to balance against. As something separate from life. A cruel requirement to earning a living.
...
To find work we enjoy, many of us have to go through many jobs we like and don't like. From each of them we learn something. There are jobs that spark your curiosity and others that can be life-draining.

In one of my first jobs, I worked as an analyst for a bank in Utah. I would have to wake up before 6 am, commute for an hour in the winter, then sit at my desk filing forms for wealthy people for 10 straight hours. By the time I left work it was dark again.

My manager would drop a stack of 15 folders on my desk. I'd open each one, read it, and manually type the information in the bank's registration website.

Once I was done, I'd go to the printer, print about 500 pages of new forms, organize them, and head back to my desk. My second day at the job one of the interns cried near the printer station lamenting she had to sit idle at the printer for hours each day.

This experience taught me there's a whole category of jobs where  your tasks can feel meaningless. Where you know at your core that the job could be automated or just exists to check a box.
...
We were a buffer between the registration site and wealthy individuals that didn't want to fill up forms online. The bank didn't want to force them either.

A survey from the UK said about 37% of British workers claimed their job "didn't make a meaningful contribution to the world". [add citation]
...
Paul Graham in his essay "[How to do Great Work](https://www.paulgraham.com/greatwork.html)" explained how to the way to know what to work on is by working. You're going to guess wrong many times and that will teach you what jobs you enjoy or not.
...
To find out I enjoyed programming I worked as a CAD designer, a business development intern for an oil company, an operations analyst for a bank, and as a management consultant for healthcare companies. 

Each of those experiences were early in my career, and while some were better than others they all gave me hints where I felt most engaged.
...
Paul Graham's essay warned in his essay of *"pretentiousness, fashion, fear, money, politics, other people's wishes, and eminent frauds. Stick to what you find interesting"*

I found out that to avoid these traps you need to spend the time asking yourself if you're engaged in your job. A sign that you're in the right field is that it becomes increasingly interesting to you as you learn more about it.

In academic environments, specially in graduate schools (i.e., MBA) it's easy to fall into *memetic thinking* [add citation], that is wishing what others want. Wanting to be in a big tech company, or in top consulting firm, or in a hot start-up. 

While those are commonly good avenues for people to develop on, they can be fraught with people resenting it's not what they thought it would be.

Once you tried a few things, and found out a field that's become increasingly interesting with time. The next step is to focus.
...
Focusing is more about picking what to work on vs. finding out what note taking tool will give you an edge in organizing your information. It's useless to spend time finding out how to do something productive that shouldn't have been done in the first place.

I've fallen trap to this many times, I've spent hours figuring out how to organize a project in Notion, or browsing reddit forums figuring out what's the best book for a subject. Instead of opening a book that's *good enough* and getting started working.
...
![Layers of Knowledge](https://substackcdn.com/image/fetch/w_1272,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8b2211f4-2314-4838-b5c0-f1a7af9738f1_908x661.png)

In order to be successful in a field you need to have a strong foundation where you can layer new knowledge.

In a Haruki Murakami’s Norwegian Wood passage Nagasawa tells the book’s protagonist, Toru Watanabe, that he only reads books whose authors have been dead for at least thirty years.
...
How to build foundational knowledge? Ask yourself, what are the concepts in my field that are not going to change in the next 5-10 years.

In computer science, it means knowing about algorithms, data structures, computer networking, or how operating systems work. 

There might be many trends of Generative AI models, but they will all have to be run on computers, use networking to communicate with each other, and apply linear algebra to predict the results.
...
Assuming you've found an area that interests you, and learned enough to be useful to any company. The last step is doing great work.

Many times it's hard to figure out if what you're doing is going to make a difference. Finding what to work on is a combination of luck and persistence. 
...
*This gentleman is Joe Hammond. He was the producer for Aretha Franklin, Billie Holiday, Count Basie. One day he walked in and found this gentleman, 1961. I think he’s 22, 23, something like that. The next year Robert Zimmerman changes his name to Bob Dylan.*

We may have to try out different things to find out what we like. But when we do, we owe it to ourselves to care about it. To learn, focus, and share our work with others.
